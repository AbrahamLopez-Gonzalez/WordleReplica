const wordPool = ["STAIR", "STARE", "CLASH", "FLASH", "CRASH", "FRAME", "PRIME", "POWER", "PROXY", "CANDY", "SEVEN", "GRADE", "STYLE", "SHELL",
    ...
    "FLUTE", "FLOUR", "FLUSH", "FLARE", "EARTH", "TARDY", "YEAST", "SOUTH", "AUDIO", "LOWER", "ARMED", "ADORE", "SPEED",
    "LEVEL", "STEAK", "STAKE"];
...
function evaluateGuess() {
    ...
    if (control_letters == 30 && correctLet.length != disectc.length) {
        console.log("That was your last try!, Good luck next time. G-G");
...
function openModal1() {
    document.getElementById("integrants").style.display = 'block';
};
...
function openModal2() {
    document.getElementById("customModalHelp").style.display = 'block';
};

function closeModal2() {
    document.getElementById("customModalHelp").style.display = 'none';
};
